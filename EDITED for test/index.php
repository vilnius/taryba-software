			...
			if ($balsavimoStatusas != "2") {
				...
				if (1 === 2) {
					...
					<div class="voters" style="position: relative; left:15%; margin-top: 3px; margin: 0px auto;">
						...
						for ($i = 0; $i < 3; $i++) {
							?>
							<div class="collumn<?php echo $i; ?>" style="width: 460px; float:left;">
								<?php
							...
							$voteResult[3][$from][4] = 'Testinis';
							$voteResult[3][$from][2] = 'Vartotojas Kazukas';
							$color = '#00e4ff';
		...
		<?php// if (file_exists($votingFile)) { ?>
								<div class="inner">
									<div class="participate">
										<div class="participate-text">Dalyvauja: <?php echo '38'; ?>
										</div>
									</div>
								</div>
								<div class="votes" style="font-size: 140%">
									...
									<font class="nebalsavo countVotes" style="color: #00e4ff; margin-left: 15px;"> NEBALSAVO: <?php echo '13'; ?></font>
								</div>
